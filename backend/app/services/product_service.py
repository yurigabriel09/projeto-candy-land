...
class ProductService:
    ...
    def _validar_restaurante_e_categoria(restaurant_id, category_id):
        ...
        if categoria.id_restaurante != restaurant_id:
            return {
                "success": False,
                "erro": "Essa categoria não pertence ao restaurante informado.",
                "status_code": 400
            }
    ...
    def criar_produto(dados):
        try:
            ...
            validacao = ProductService._validar_restaurante_e_categoria(
                restaurant_id,
                category_id
            )
    ...
    def atualizar_produto(produto_id, dados):
        try:
            ...
            novo_restaurant_id = dados.get(
                "restaurante_id",
                produto.restaurant_id
            )
            novo_category_id = dados.get(
                "categoria_id",
                produto.category_id
            )
            ...
            if "restaurante_id" in dados:
                produto.restaurant_id = dados["restaurante_id"]
